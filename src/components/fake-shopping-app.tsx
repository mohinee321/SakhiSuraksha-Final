      ...
      <div className="mx-4 mt-4 p-4 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 rounded-xl text-white shadow-lg">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-pink-100">Up to 70% off on trending fashion • Free shipping above ₹1999</p>
          </div>
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">{products.length} items • Updated 2 hours ago</p>
          </div>
          <div className="flex gap-2">
